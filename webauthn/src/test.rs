...
use cosmwasm_std::{coin, to_binary, BankMsg, CosmosMsg};
use sylvia::types::QueryCtx;
use vectis_wallet::{authenicator_export::AuthenicatorExport, VectisRelayedTx};
...
const HASH_COSMOS_MSG: [u8; 32] = [
    100, 101, 147, 64, 29, 45, 181, 1, 233, 173, 32, 242, 187, 38, 175, 66, 241, 75, 146, 211, 140,
    153, 165, 26, 201, 72, 41, 226, 150, 140, 31, 57,
];
...
const RAWSIGN: [u8; 64] = [
    239, 139, 59, 204, 38, 219, 76, 13, 81, 227, 244, 206, 106, 106, 82, 233, 224, 66, 106, 231,
    148, 119, 165, 59, 129, 5, 37, 86, 23, 26, 127, 230, 245, 7, 2, 167, 86, 219, 132, 126, 6, 203,
    61, 98, 248, 2, 14, 132, 111, 193, 212, 143, 212, 201, 248, 197, 239, 30, 189, 97, 112, 61, 42,
    195,
];

// This is the concat of (AUTH_DATA, hash(CLIENT_DATA))
const AUTH_SIGNED_DATA: [u8; 69] = [
    160, 69, 228, 49, 29, 7, 49, 76, 44, 221, 70, 108, 153, 137, 118, 53, 175, 165, 26, 158, 250,
    12, 31, 58, 208, 251, 254, 192, 151, 172, 43, 29, 1, 0, 0, 0, 0, 254, 199, 209, 17, 106, 182,
    239, 149, 80, 97, 16, 169, 232, 62, 189, 60, 96, 199, 136, 86, 61, 89, 226, 184, 73, 106, 44,
    99, 130, 101, 197, 48,
];
